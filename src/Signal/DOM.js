...
export function keyPressedP (constant) {
...
export function mouseButtonP (constant) {
...
export function touchP (constant) {
  var out = constant([])
  function report (e) {
    var touches = [],
      i,
...
export function mousePosP (constant) {
...
export function animationFrameP (constant) {
  return function (now) {
    return function () {
...
export function windowDimensionsP (constant) {
